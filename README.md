...
[Soil Moisture Sensor Guide](https://learn.sparkfun.com/tutorials/soil-moisture-sensor-hookup-guide?_ga=2.250722821.2011127879.1551811690-2119149971.1551811690)  when the senor is dry (~0) and when it is completely saturated with moisture (~880).
