...
**Case 1.** According to [Web Thing API Specification](https://iot.mozilla.org/wot/#example-2-a-more-complex-thing-description-with-semantic-annotations), the events member is a map of `Event` objects which define the types of events which may be emitted by a device. 
